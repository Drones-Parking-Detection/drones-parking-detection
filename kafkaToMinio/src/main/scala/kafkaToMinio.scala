...
//    val droneData = kafkaStream.selectExpr("CAST(value AS STRING)")
...
//            .master("local[*]") // Change this as per your cluster configuration
//            .getOrCreate()
    ...
    //      // Reading from Kafka
          val kafkaDF = spark.readStream
            ...
            .load()
    //
    //      // Kafka message value is in binary format, we need to cast it to String
...
//          // Write the processed data to the console for demonstration
